...
async def main_handler(update, context):
    ...
    if 'START SNIPER' in cmd or 'REFRESH' in cmd:
        ...
        if await force_scour():
            ...
            await m.edit_text("<b> 🛰️ ACTIVE TARGETS:</b>", reply_markup=InlineKeyboardMarkup(kb), parse_mode='HTML')
        ...
        await update.message.reply_text(" <b>⚙️ CALIBRATE STRIKE SIZE:</b>", reply_markup=InlineKeyboardMarkup(kb), parse_mode='HTML')
...
async def handle_query(update, context):
    ...
    if "SET_" in q.data:
        ...
        if allowance < (stake * 1e6):
            ...
            await context.bot.send_message(q.message.chat_id, " <b>⚠️ USDC.e PERMISSION REQUIRED</b>", reply_markup=InlineKeyboardMarkup(kb), parse_mode='HTML'); return
        try:
            ...
            if resp.get("success"):
                ...
                msg = (f"🚀 <b>ATOMIC STRIKE CONFIRMED</b>\n"
                       ...
                       f"━━━━━━━━━━━━━━\n"
                       f"<i>🕵️ Monitoring for resolution...</i>")
        ...
        except Exception as e: await context.bot.send_message(q.message.chat_id, f" <b>⚠️ SDK ERROR:</b> {str(e)}", parse_mode='HTML')
