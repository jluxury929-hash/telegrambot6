    ...
    if "SET_" in query.data:
        ...
        try:
            ...
            if resp.get("success"):
                ...
                # --- ADDED ERRORMSG ---
                await context.bot.send_message(query.message.chat_id, f"{LOSE_LOGO}: {resp.get('errorMsg')}", parse_mode='HTML')
                # ----------------------
        except Exception as e:
